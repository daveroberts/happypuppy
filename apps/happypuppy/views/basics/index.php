...
<div class="example">
<p><?= link_to_action("Single argument", 'show', 44); ?></p>
<pre>
...
<div class="example">
<p><?= link_to_action('Multiple arguments', 'showboth', array('first', 'second')); ?></p>
<pre>
...
<div class="example">
<p><?= link_to_url("Custom Route", '/2009/01/20/blog/Hope'); ?></p>
